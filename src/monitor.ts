...
const teamNameAliases = new Map<string, TeamAlias[]>([
  ...
  // NCAAB only
  ["VCU", [{ league: 2, aliases: ["VCU", "Virginia Commonwealth", "Va Commonwealth"] }]],
  ...
  ["Sam Houston", [{ league: 2, aliases: ["Sam Houston", "Sam Houston State"] }]],
  ["Illinois Chicago", [{ league: 2, aliases: ["Illinois Chicago", "UIC", "Illinois-Chicago"] }]],
  ["North Dakota State", [{ league: 2, aliases: ["North Dakota State", "N. Dakota State"] }]],
  ["Hawaii", [{ league: 2, aliases: ["Hawaii", "Hawai'i"] }]],
  ["Saint Louis", [{ league: 2, aliases: ["Saint Louis", "St. Louis"] }]],
  ["Queens NC", [{ league: 2, aliases: ["Queens NC", "Queens (NC)"] }]],
  ["Saint Mary's", [{ league: 2, aliases: ["Saint Mary's", "St. Mary's", "Saint Marys CA", "St. Mary's (CA)"] }]],
  ["Saint Joseph's", [{ league: 2, aliases: ["Saint Joseph's", "St. Joseph's", "St. Joseph's (PA)", "St Joseph's"] }]],
...
const sportsConfig = {
  ...
  NCAAB: {
    ...
    seasonEnd: '2026-03-16',
    postseasonStart: '2026-03-16',
    postseasonEnd: '2026-04-08',
